...
CENTRAL_WALLET = 'Lc2c7AF76B8MD8ySWMbttuc7cYc3hnDB55'	# local coin address where money goes

COINDAEMON_TRUSTED_HOST = 'localhost'
COINDAEMON_TRUSTED_PORT = 11000
COINDAEMON_TRUSTED_USER = 'test'
COINDAEMON_TRUSTED_PASSWORD = 'test1'
...
DB_MYSQL_DBNAME = 'mpos3'
DB_MYSQL_USER = 'root'
DB_MYSQL_PASS = 'hanxianzhai@gmail.com'
